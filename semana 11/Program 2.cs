class Program
{
    static void Main(string[] args)
    {
        ...
        for (int i = 0; i < 1; i++)
        {
            Console.Write("Ingresar la cantidad de mujeres en el nivel 1: ");
        ...
        for (int i = 1; i < 2; i++)
        {
            Console.Write("Ingresar la cantidad de mujeres en el nivel 2: ");
            n = int.Parse(Console.ReadLine());
            ventas[i] = n;
        ...
        for (int i = 2; i < 3; i++)
        {
            Console.Write("Ingresar la cantidad de mujeres en el nivel 3: ");
            n = int.Parse(Console.ReadLine());
            ventas[i] = n;
        ...
        for (int i = 3; i < 4; i++)
        {
            Console.Write("Ingresar la cantidad de mujeres en el nivel 4: ");
            n = int.Parse(Console.ReadLine());
            ventas[i] = n;
        ...
        for (int i = 4; i < 5; i++)
        {
            Console.Write("Ingresar la cantidad de mujeres en el nivel 5: ");
            n = int.Parse(Console.ReadLine());
            ventas[i] = n;
